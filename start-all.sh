...
echo ""
echo "For local domain mapping, add to /etc/hosts:"
echo "  127.0.0.1 bfftracker.net urlocalbff.com"
echo "Then access:"
echo "  Admin Portal: http://bfftracker.net:3001"
echo "  Website:      http://urlocalbff.com:3000"
echo "  Client Portal: http://urlocalbff.com:3002"
echo ""
